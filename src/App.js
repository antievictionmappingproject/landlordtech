...
class App extends Component {
  ...
  async loadData(){
    ...
    const response = await fetch('https://cors-anywhere.dfdev.dataplusfeminism.mit.edu/https://docs.google.com/spreadsheets/d/e/2PACX-1vT6CdlROYPNn9Z6xGZqcFgh9toXFFlR510iX24tJk1Mb3NclHDqv4Tq5bw93vBVaYQNVZrBaMjMJI1h/pub?output=csv', { method: "get" });
